...
- Fix the build not picking up any of my recent API changes!

- Fix the TileMap property on Surface.
  - The raw pointer is no good. There is an inconsistent invalid memory access crash when starting up.
