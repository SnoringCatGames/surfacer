...
const JumpInterSurfaceCalculator := preload("res://framework/platform_graph/edge/edge_calculators/jump_inter_surface_calculator.gd")
#const TestPlayerParams := preload("res://framework/test/data/test_player_params.gd")
...
var jump_from_platform_movement: JumpInterSurfaceCalculator
var level: Level
...
#        if movement_calculator is JumpInterSurfaceCalculator:
