extends Reference
class_name FrameCollisionCheckUtilsOld
...
static func check_frame_for_collision( \
    ...
    var space_state := collision_params.space_state
    var collider_half_width_height := \
            collision_params.movement_params.collider_half_width_height
    var collider_rotation := collision_params.movement_params.collider_rotation
    var surface_parser := collision_params.surface_parser
