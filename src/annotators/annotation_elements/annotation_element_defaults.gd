...
const COLLISION_CHARACTER_BOUNDARY_STROKE_WIDTH_FAINT := 1.0
const COLLISION_CHARACTER_BOUNDARY_STROKE_WIDTH_STRONG := 2.0
const COLLISION_CHARACTER_BOUNDARY_CENTER_RADIUS := 3.0
...
const NAVIGATOR_PULSE_STROKE_WIDTH := NAVIGATOR_TRAJECTORY_STROKE_WIDTH * 3.0
...
const NAVIGATOR_TRAJECTORY_DOWNBEAT_HASH_LENGTH := \
        NAVIGATOR_TRAJECTORY_STROKE_WIDTH * 5
const NAVIGATOR_TRAJECTORY_OFFBEAT_HASH_LENGTH := \
