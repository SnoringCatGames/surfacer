...
var distance_squared_threshold_for_considering_additional_jump_land_points := \
        128.0 * 128.0
...
# negatives.
var backtracks_to_consider_higher_jumps_during_horizontal_step_calculations := \
        true
...
#     is true.
var prevents_path_end_points_from_protruding_past_surface_ends_with_extra_offsets := \
        false
...
#     ceiling.
var checks_for_alternate_intersection_points_for_very_oblique_collisions := \
        true
...
var reached_in_air_destination_distance_squared_threshold := 16.0 * 16.0
