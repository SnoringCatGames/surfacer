...
func _draw_shape(
    ...
    var cone_length: float = \
            SurfacerDrawUtils.EDGE_END_CONE_LENGTH * SCALE * Gs.gui.scale
    var radius: float = \
            SurfacerDrawUtils.EDGE_END_RADIUS * SCALE * Gs.gui.scale
    var length := cone_length + radius * Gs.gui.scale
