...
void MovementProfile::_bind_methods() {
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_grab_walls"), "set_can_grab_walls",
			"get_can_grab_walls");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_grab_ceilings"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_grab_floors"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_jump"), "set_can_jump",
			"get_can_jump");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_dash"), "set_can_dash",
			"get_can_dash");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_double_jump"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "can_target_in_air_destinations"),
			"set_can_target_in_air_destinations",
			"get_can_target_in_air_destinations");
	// END GROUP "Movement abilities"

	ADD_GROUP("Physics movement", "");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "surface_speed_multiplier",
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "air_horizontal_speed_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "gravity_multiplier", PROPERTY_HINT_RANGE,
					"0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "gravity_slow_rise_multiplier_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"gravity_double_jump_slow_rise_multiplier_"
					"multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
			"set_gravity_double_jump_slow_rise_multiplier_multiplier",
			"get_gravity_double_jump_slow_rise_multiplier_multiplier");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "walk_acceleration_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "in_air_horizontal_acceleration_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "climb_up_speed_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "climb_down_speed_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "ceiling_crawl_speed_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "friction_coefficient_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "jump_boost_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "wall_jump_horizontal_boost_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "wall_fall_horizontal_boost_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "ceiling_fall_velocity_boost",
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "max_horizontal_speed_default_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "max_vertical_speed_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "fall_through_floor_velocity_boost",
					PROPERTY_HINT_RANGE, "0.0,1000.0,1.0"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "stops_on_slope"), "set_stops_on_slope",
			"get_stops_on_slope");
	// END GROUP "Physics movement"
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "speed_multiplier_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "vertical_boost_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "duration_multiplier", PROPERTY_HINT_RANGE,
					"0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "fade_duration_multiplier",
					PROPERTY_HINT_RANGE, "0.1,10.0,0.1"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "cooldown_multiplier", PROPERTY_HINT_RANGE,
					"0.1,10.0,0.1"),
			"set_dash_cooldown_multiplier", "get_dash_cooldown_multiplier");
	// END GROUP "Dash"

	ADD_GROUP("Double jump", "");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::INT, "max_jump_chain", PROPERTY_HINT_RANGE,
					"0,10,1"),
			"set_max_jump_chain", "get_max_jump_chain");
	// END GROUP "Double jump"

	ADD_GROUP("Edge weights", "");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"uses_duration_instead_of_distance_for_edge_"
					"weight"),
			"set_uses_duration_instead_of_distance_for_edge_weight",
			"get_uses_duration_instead_of_distance_for_edge_weight");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "additional_edge_weight_offset_override"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "walking_edge_weight_multiplier_override"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"ceiling_crawling_edge_weight_multiplier_"
					"override"),
			"set_ceiling_crawling_edge_weight_multiplier_override",
			"get_ceiling_crawling_edge_weight_multiplier_override");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "climbing_edge_weight_multiplier_override"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"climb_to_adjacent_surface_edge_weight_"
					"multiplier_"
					"override"),
			"set_climb_to_adjacent_surface_edge_weight_multiplier_override",
			"get_climb_to_adjacent_surface_edge_weight_multiplier_override");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"move_to_collinear_surface_edge_weight_"
					"multiplier_"
					"override"),
			"set_move_to_collinear_surface_edge_weight_multiplier_override",
			"get_move_to_collinear_surface_edge_weight_multiplier_override");
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::FLOAT, "air_edge_weight_multiplier_override"),
			"set_air_edge_weight_multiplier_override",
			"get_air_edge_weight_multiplier_override");
	// END GROUP "Edge weights"

	ADD_GROUP("Surface graph calculations", "");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "minimizes_velocity_change_when_jumping"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "optimizes_edge_jump_positions_at_run_time"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "optimizes_edge_land_positions_at_run_time"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "also_optimizes_preselection_path"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"forces_character_position_to_match_edge_at_"
					"start"),
			"set_forces_character_position_to_match_edge_at_start",
			"get_forces_character_position_to_match_edge_at_start");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"forces_character_velocity_to_match_edge_at_"
					"start"),
			"set_forces_character_velocity_to_match_edge_at_start",
			"get_forces_character_velocity_to_match_edge_at_start");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"forces_character_position_to_match_path_at_"
					"end"),
			"set_forces_character_position_to_match_path_at_end",
			"get_forces_character_position_to_match_path_at_end");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"forces_character_velocity_to_zero_at_path_end"),
			"set_forces_character_velocity_to_zero_at_path_end",
			"get_forces_character_velocity_to_zero_at_path_end");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "includes_continuous_trajectory_positions"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "includes_continuous_trajectory_velocities"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "includes_discrete_trajectory_state"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "is_trajectory_state_stored_at_build_time"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::BOOL, "bypasses_runtime_physics"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::INT, "default_nav_interrupt_resolution_mode"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"min_intra_surface_distance_to_optimize_jump_"
					"for"),
			"set_min_intra_surface_distance_to_optimize_jump_for",
			"get_min_intra_surface_distance_to_optimize_jump_for");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"dist_sq_thres_for_considering_additional_jump_"
					"land_"
					"points"),
			"set_dist_sq_thres_for_considering_additional_jump_land_points",
			"get_dist_sq_thres_for_considering_additional_jump_land_points");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"stops_after_finding_first_valid_edge_for_a_"
					"surface_"
					"pair"),
			"set_stops_after_finding_first_valid_edge_for_a_surface_pair",
			"get_stops_after_finding_first_valid_edge_for_a_surface_pair");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"always_includes_jump_land_positions_at_surface_"
					"ends"),
			"set_always_includes_jump_land_positions_at_surface_ends",
			"get_always_includes_jump_land_positions_at_surface_ends");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"includes_redundant_j_l_positions_with_zero_"
					"start_"
					"velocity"),
			"set_includes_redundant_j_l_positions_with_zero_start_velocity",
			"get_includes_redundant_j_l_positions_with_zero_start_velocity");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"exceptional_jump_instruction_duration_"
					"increase"),
			"set_exceptional_jump_instruction_duration_increase",
			"get_exceptional_jump_instruction_duration_increase");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"recurses_when_colliding_during_horizontal_step_"
					"calculations"),
			"set_recurses_when_colliding_during_horizontal_step_calculations",
			"get_recurses_when_colliding_during_horizontal_step_calculations");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"backtracks_for_higher_jumps_during_hor_step_"
					"calculations"),
			"set_backtracks_for_higher_jumps_during_hor_step_calculations",
			"get_backtracks_for_higher_jumps_during_hor_step_calculations");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "collision_margin_for_edge_calculations"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "collision_margin_for_waypoint_positions"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "skips_less_likely_jump_land_positions"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"prevents_path_ends_from_exceeding_surface_ends_"
					"with_"
					"offsets"),
			"set_prevents_path_ends_from_exceeding_surface_ends_with_offsets",
			"get_prevents_path_ends_from_exceeding_surface_ends_with_offsets");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"reuses_previous_waypoints_when_backtracking_on_"
					"jump_"
					"height"),
			"set_reuses_previous_waypoints_when_backtracking_on_jump_height",
			"get_reuses_previous_waypoints_when_backtracking_on_jump_height");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"asserts_no_preexisting_collisions_during_edge_"
					"calculations"),
			"set_asserts_no_preexisting_collisions_during_edge_calculations",
			"get_asserts_no_preexisting_collisions_during_edge_calculations");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL,
					"checks_for_alt_intersection_points_for_oblique_"
					"collisions"),
			"set_checks_for_alt_intersection_points_for_oblique_collisions",
			"get_checks_for_alt_intersection_points_for_oblique_collisions");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"oblique_collison_normal_aspect_ratio_"
					"threshold"),
			"set_oblique_collison_normal_aspect_ratio_threshold",
			"get_oblique_collison_normal_aspect_ratio_threshold");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::INT,
					"min_frame_count_when_colliding_early_with_"
					"expected_"
					"surface"),
			"set_min_frame_count_when_colliding_early_with_expected_surface",
			"get_min_frame_count_when_colliding_early_with_expected_surface");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"reached_in_air_destination_distance_squared_"
					"threshold"),
			"set_reached_in_air_destination_distance_squared_threshold",
			"get_reached_in_air_destination_distance_squared_threshold");
	ClassDB::bind_method(
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::INT,
					"max_edges_to_remove_from_path_for_opt_to_in_"
					"air_"
					"dest"),
			"set_max_edges_to_remove_from_path_for_opt_to_in_air_dest",
			"get_max_edges_to_remove_from_path_for_opt_to_in_air_dest");
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::BOOL, "always_tries_to_face_direction_of_motion"),
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"max_distance_for_reachable_surface_tracking"),
			"set_max_distance_for_reachable_surface_tracking",
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::FLOAT, "friction_coeff_with_sideways_input"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::FLOAT, "walking_edge_weight_multiplier"), "",
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT, "ceiling_crawling_edge_weight_multiplier"),
	...
	ADD_PROPERTY(
			PropertyInfo(Variant::FLOAT, "climbing_edge_weight_multiplier"), "",
	...
	ADD_PROPERTY(
			PropertyInfo(
					Variant::FLOAT,
					"smaller_of_max_surface_and_air_horizontal_"
					"speed"),
			"", "get_smaller_of_max_surface_and_air_horizontal_speed");
	// END GROUP "Surface graph calculations"
}
